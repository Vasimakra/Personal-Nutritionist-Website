...
//session_start(); 	
	...
	{                                                                                                                                                                                                                                                                                                                                                                                                                        
		...
		$o = $_POST['pre'];
		 ...
		 $insert= mysqli_query($mysqli_conn,"insert into additem(food_id,food_name,fcalories,protien,fat,saturatedfat,polyfat,monofat,Tfat,cholesterol,fileName,sodium,potassium,tcarbo,dfiber,sugar,pre) values('$a','$b','$r','$c','$d','$e','$f','$g','$h','$i','$image','$j','$k','$l','$m','$n','$o')");
