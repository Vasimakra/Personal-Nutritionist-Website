                     ...
                     <tbody>
						...
						?>
							<tr>
								...
								<td><a href = "itemedit.php?id=<?php echo $row['food_id'];?>"<button type="button" class="btn btn-warning">EDIT</button></a></td>
								<td><a href = "itemdelete.php?del=<?php echo $row['food_id'];?>"<button type="button" class="btn btn-danger">DELETE</button></a></td>
							</tr>
								<?php
									}
