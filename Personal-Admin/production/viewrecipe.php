  ...
  <div class="container body">
	...
	<div class="row">
			  ...
			  <div class='col-sm-2 label-align'><input type ='text' name='food_name' disabled value="<?php echo $row['food_name'];?>" class='form-control'></div>
			   ...
			   <div class='col-sm-2 label-align'> <input type ='text' name='Ptime' disabled value="<?php echo $row['Ptime'];?>" class='form-control'></div>
	<br>
	</div>	
<br>	
		<div class="row">
			...
			<div class='col-sm-2 label-align'><label>Food-Title</label></div>
			  <div class='col-sm-2 label-align'> <textarea  name='FTmessage' disabled class='form-control'>
					<?php echo $row['FTmessage'];?>
			  </textarea></div>
				<div class='col-sm-2 label-align'><label>Cooking Time</label></div>
			  <div class='col-sm-2 label-align'><input type ='text' name='cooktime' disabled value="<?php echo $row['cooktime'];?>" class='form-control'></div>
			   <div class='col-sm-2 label-align'> <label>Meal Type</label></div>
			   <div class='col-sm-2 label-align'><input type ='text' name='Mtype' disabled value="<?php echo $row['Mtype'];?>" class='form-control'></div>
	...
	<div class="row">
			...
			<div class='col-sm-2 label-align'><label>Ingredints</label></div>
			  <div class='col-sm-2 label-align'><textarea rows="15" cols="15"  name='Imessage' disabled class='form-control'>
					<?php echo $row['Imessage'];?>
			  </textarea></div>
				<div class='col-sm-2 label-align'><label>Directions</label></div>
			  <div class='col-sm-2 label-align'><textarea rows="15" cols="15"  name='Dmessage' disabled class='form-control'>
				<?php echo $row['Dmessage'];?>
			  </textarea></div>
			   <div class='col-sm-2 label-align'> <label>Nutrition Details</label></div>
			   <div class='col-sm-2 label-align'><textarea rows="15" cols="15"  name='Nmessage' disabled class='form-control'>
			  ...
			  <div class='col-sm-2 label-align'><input type ='text' name='serve' disabled value="<?php echo $row['serve'];?>"class='form-control'></div>
