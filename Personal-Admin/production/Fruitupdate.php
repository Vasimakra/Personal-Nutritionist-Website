<?php
	...
	if(isset($_POST['update']))
	{
		...
		$n = $_POST['sugar'];
		$o = $_POST['pre'];	
		$query ="UPDATE additem SET food_name='$b', fcalories='$r',protien='$c',fat='$d',saturatedfat='$e',polyfat='$f',monofat='$g',Tfat='$h',cholesterol='$i',fileName='$image',sodium='$j',potassium='$k',tcarbo='$l',dfiber='$m',sugar='$n',pre='$o' WHERE food_id='$a'";
