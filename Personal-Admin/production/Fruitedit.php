                ...
                <div class="">
                    <div class="page-title">`
						...
						<?php
							...
							$item = $_GET['id'];
							$qu = "SELECT * FROM additem where food_id = '$item'";
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="form-group" action="Fruitupdate.php" method="POST" enctype ="multipart/form-data" novalidate>
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    <a href="fruitslist.php" <button type="button" class="btn btn-success"> BACK </button></a>
